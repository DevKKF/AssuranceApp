            ...
            if quittance_existant:
                ...
                if police:
                    ...
                    new_quittance = Quittance(
                        ...
                        #autres_taxes=quittance_veos.TSVL +  quittance_veos.CSS +  CSS_OLEA,
    ...
    sinistres = [
        {
            ...
            'MONTANT_ORDON': '0',
            'MONTANT_REMB': None,
            'ACTE_CODE_GROUPE_OLEA': 'PHARMACIE',
            'ACTE_LIBELLE_GROUPE_OLEA': 'PHARMACIE / VITAMINE / VACCINS',
            'ID_MEDTRAITANT': None,
        ...
        for sv in sinistres_veos:
            ...
            if existing_record:
                ...
                if not existing_record.dossier_sinistre:
                    ...
                    existing_record.ticket_prefinance = sv.TICKET_PREFINANCE
                    existing_record.net_regle = sv.NET_REGLE
                    existing_record.montant_remboursement_accepte = sv.PART_OLEA
                ...
                if acte and aliment:
                    ...
                    new = Sinistre(
                        ...
                        montant_remboursement_accepte=sv.PART_OLEA,
...
def get_actes_lists():
    ...
    if api_response['statusCode'] == 0:
        ...
        for acte in actes:
            ...
            rubriques = Rubrique.objects.filter(code=acte['cd_group_olea'])
...
def send_sinistres():
    ...
    for sinistre in sinistres:
        ...
        data = {
            ...
            "numSoc": sinistre.police.bureau.code, #-- numsoc bureau olea
            ...
            "infos": {
                ...
                "ACT_DEF2": "",
                "ACT_GROL_CODE": "INFIRMERIE", #-- Code regroupement acte OLEA
                "ACT_GROL_LIB": "INFIRMIER ET ACTES D'INFIRMERIE", #-- Libellé regroupement OLEA
                "RUB_ID_GRPC": "",
                "RUB_DUREE": "",
                "RUB_UNITE": "",
                "RUB_PLAFOND": "",
                ...
                "RESUME_RUB_PL_PER": "-",
                "RUB_LIB": "",
                "GAR_GROL_CODE": "GINFIRMERIE", #-- Code regroupement garantie OLEA
                "G_LETTRE": "",
                "TM_AVOL": "0",
                "CALCULTM": "SURPLAFOND",
                "BORD": "",
