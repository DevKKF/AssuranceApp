...
BASE_URLS = {
    'default': 'https://olea.veos.iga.fr',
    'olea2': 'https://olea2.preprod-veos.iga.fr',
    'recSante': 'https://oleasante.rec-veos.iga.fr',
    'prod': 'https://olea.prod-veos.iga.fr/rs/rsExtranet2',
}
# utils.py
