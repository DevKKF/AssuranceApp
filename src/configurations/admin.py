...
admin.site.site_header = 'OLEA SANTE'
...
class TarifExcelAdmin(ImportExportModelAdmin):
    list_display = ('CODE_REGROUPEMENT_OLEA', 'LIBELLE_ACTE', 'CODE_ACTE', 'LETTRE_CLE_CLASSIQUE', 'COEF_CLASSIQUE', 'PU_CLASSIQUE', 'COUT_CLASSIQUE', 'PU_MUTUELLE', 'COUT_MUTUELLE', 'PU_PUBLIC_HG', 'COUT_PUBLIC_HG')
    list_filter = ('CODE_REGROUPEMENT_OLEA', 'LIBELLE_ACTE', 'CODE_ACTE')  # Vous pouvez ajouter d'autres champs de filtrage si nécessaire
    search_fields = ('CODE_REGROUPEMENT_OLEA', 'LIBELLE_ACTE', 'CODE_ACTE')  # Vous pouvez ajouter d'autres champs de recherche si nécessaire
    list_per_page = 10
