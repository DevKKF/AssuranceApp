...
class OnBoardingView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #   base_url = 'https://preprod.oleasante.com'
        #   base_url = 'https://oleasante.com'
        #   base_url ='http://127.0.0.1:8000'

        if request.META.get('HTTP_HOST') == 'preprod.oleasante.com':
            base_url = 'https://preprod.oleasante.com'

        elif request.META.get('HTTP_HOST') == 'oleasante.com':
            base_url = 'https://oleasante.com'
